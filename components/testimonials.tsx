...
import notion from '@/public/images/partners/notion.png'
import zendesk from '@/public/images/partners/zendesk.png'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-xl font-semibold " data-aos="zoom-y-out">Trusted by these partners, our community benefit from more than $50k in deals from the generous companies that support our community</p>
          </div>
          ...
          <div className="max-w-sm md:max-w-4xl mx-auto grid gap-2 grid-cols-4 [&>div>img]:grayscale">
            ...
            <div data-aos="zoom-y-out" className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={notion} alt='Logo of Notion' width={120} />
            </div>

            {/* Item Zendesk */}
            <div data-aos="zoom-y-out" className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <Image src={zendesk} alt='Logo of Zendesk' width={120} />
            </div>

            {/* Item  AMAZON*/}
            <div data-aos="zoom-y-out" className="flex items-center justify-center py-2 col-span-2 md:col-auto">
              <svg width="100" height="35" viewBox="0 0 109 33" xmlns="http://www.w3.org/2000/svg">
